...
import { testes } from '../messages/Events';
...
export default class Teste {
    ...
    public static carregar(a:any, tipo:any) {

        if (`../AV1/src/files/testes/${a}${tipo}.txt`) {
            const fl = fs.readFileSync(`../AV1/src/files/testes/${a}${tipo}.txt`, 'utf-8')
    ...
    private filePath(a: Aeronave) { return `../AV1/src/files/testes/${a.codigo}${this.tipo}.txt` }
